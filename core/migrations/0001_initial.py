...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specialty', models.CharField(choices=[('CARDIOLOGY', 'Cardiología'), ('DERMATOLOGY', 'Dermatología'), ('NEUROLOGY', 'Neurología'), ('PEDIATRICS', 'Pediatría'), ('OTHER', 'Otra Especialidad')], default='OTHER', max_length=50, verbose_name='Especialidad Médica')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergies', models.TextField(blank=True, help_text='Lista de alergias del paciente, incluyendo severidad y reacciones', verbose_name='Alergias')),
            ],
            options={
