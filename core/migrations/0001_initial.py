    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('A', 'Disponible'), ('O', 'Ocupada'), ('M', 'En Mantenimiento')], default='A', max_length=1, verbose_name='Estado')),
            ],
            options={
                'verbose_name': 'Cama',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.department', verbose_name='Departamento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discharge_date', models.DateTimeField(blank=True, null=True, verbose_name='Fecha de Alta')),
                ('reason', models.TextField(verbose_name='Motivo de Ingreso')),
                ('bed', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.bed', verbose_name='Cama')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.patient', verbose_name='Paciente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('A', 'Activa'), ('C', 'Completada'), ('D', 'Cancelada')], default='A', max_length=1, verbose_name='Estado')),
                ('medical_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.medicalrecord', verbose_name='Historial Médico')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('GEN', 'General'), ('ICU', 'UCI'), ('OR', 'Quirófano'), ('ER', 'Sala de Emergencias')], max_length=5, verbose_name='Tipo de Habitación')),
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.department', verbose_name='Departamento')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='bed',
            name='room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.room', verbose_name='Habitación'),
        ),
        migrations.CreateModel(
            name='Appointment',
            fields=[
            ...
            options={
                ...
                'ordering': ['-date', '-time'],
                'indexes': [models.Index(fields=['date'], name='core_appoin_date_a776ae_idx'), models.Index(fields=['time'], name='core_appoin_time_dd5400_idx'), models.Index(fields=['status'], name='core_appoin_status_e978b8_idx')],
                'constraints': [models.UniqueConstraint(fields=('doctor', 'date', 'time'), name='unique_doctor_timeslot', violation_error_message='El médico ya tiene una cita programada en este horario')],
            },
        ),
        migrations.CreateModel(
            name='Allergy',
            fields=[
                ...
                ('severity', models.CharField(choices=[('M', 'Leve'), ('MO', 'Moderada'), ('S', 'Severa')], max_length=2, verbose_name='Severidad')),
                ('reaction_description', models.TextField(verbose_name='Descripción de la Reacción')),
                ('first_diagnosed', models.DateField(blank=True, null=True, verbose_name='Fecha del Primer Diagnóstico')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.patient', verbose_name='Paciente')),
            ],
            options={
