...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('document_type', models.CharField(choices=[('DNI', 'DNI'), ('CE', 'Carnet de Extranjería'), ('PAS', 'Pasaporte'), ('OTRO', 'Otro')], default='DNI', max_length=10, verbose_name='Tipo de documento')),
                ...
                ('height', models.DecimalField(blank=True, decimal_places=2, help_text='Talla en centímetros', max_digits=5, null=True, verbose_name='Talla (cm)')),
                ('weight', models.DecimalField(blank=True, decimal_places=2, help_text='Peso en kilogramos', max_digits=5, null=True, verbose_name='Peso (kg)')),
